...
from services.user import check_user_exist, create_and_save_user, get_current_user, hash_password, delete_candidatures, delete_competences, delete_entreprise, delete_resource, update_user
...
@router.delete("/users")
def delete_user_by_id(current_user: Annotated[User, Depends(get_current_user)], db: Session = Depends(get_db)):
